...
public class EditCost extends FragmentActivity  implements DatePickerDialog.OnDateSetListener {
    ...
    private int orig_year, orig_month, orig_day;
    //rivate TextView display;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString content = new SpannableString(bundle.getString("Money"));
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(EditCost.this);

                            /*final EditText input = new EditText(Cost.this);
                            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                                    LinearLayout.LayoutParams.MATCH_PARENT,
                                    LinearLayout.LayoutParams.MATCH_PARENT);
                            input.setLayoutParams(lp);*/
                            LayoutInflater inflater = LayoutInflater.from(EditCost.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                                                                ...
                                                                new String[] {getResources().getString(R.string.kind_food),
                                                                        getResources().getString(R.string.kind_traffic),
                                                                        getResources().getString(R.string.kind_fun),
                                                                        getResources().getString(R.string.kind_others)});
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            DatabaseHandler db = new DatabaseHandler(EditCost.this, String.valueOf(month), String.valueOf(year));
                            ...
                            if (orig_month == month) {
                                Log.v("same", "" + orig_month);
                                db.update(new Statistics(bundle.getString("id"), String.valueOf(month), String.valueOf(day), 1, select, Integer.parseInt(getDollar), comment.getText().toString(), String.valueOf(year)));
                            } else {
                                db.delete(Integer.parseInt(bundle.getString("id")), orig_year, orig_month, Integer.parseInt(bundle.getString("Money")), "cost");
                                db.insert(new Statistics(String.valueOf(month), String.valueOf(day), 1, select, Integer.parseInt(getDollar), comment.getText().toString(), String.valueOf(year)));
                            }//Toast.makeText(EditCost.this, "" + db.getsum(), Toast.LENGTH_LONG).show();
                            ...
                            double monthcost = db.getMonthCost(String.valueOf(nowYear), String.valueOf(nowMonth));
                            ...
                            if(MyWindowManager.smallWindow != null){
                                MyWindowManager.removeSmallWindow(EditCost.this);
                                MyWindowManager.createSmallWindow(EditCost.this);
    ...
    public void setCurrentDateOnView() {
        ...
        orig_year = Integer.parseInt(bundle.getString("year"));
        year = orig_year;
        orig_month = Integer.parseInt(bundle.getString("month"));
        month = orig_month;
        orig_day = Integer.parseInt(bundle.getString("Date"));
        day = orig_day;
    }
