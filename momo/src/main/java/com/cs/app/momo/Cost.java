...
public class Cost extends FragmentActivity  implements DatePickerDialog.OnDateSetListener {
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(Cost.this);
                            ...
                            LayoutInflater inflater = LayoutInflater.from(Cost.this);
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            DatabaseHandler db = new DatabaseHandler(Cost.this, String.valueOf(month), String.valueOf(year));
                            ...
                            if(MyWindowManager.smallWindow != null){
                                ...
                                MyWindowManager.removeSmallWindow(Cost.this);
                                MyWindowManager.createSmallWindow(Cost.this);
