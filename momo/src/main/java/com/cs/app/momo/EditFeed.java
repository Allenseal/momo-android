...
public class EditFeed extends FragmentActivity implements DatePickerDialog.OnDateSetListener  {
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(EditFeed.this);
                            ...
                            LayoutInflater inflater = LayoutInflater.from(EditFeed.this);
                ...
                new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View v, MotionEvent event) {
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            DatabaseHandler db = new DatabaseHandler(EditFeed.this, String.valueOf(month), String.valueOf(year));
                            ...
                            Log.v("Save Button", String.valueOf(month));
                            if (orig_month == month) {
                                db.update(new Statistics(bundle.getString("id"), String.valueOf(month), String.valueOf(day), 0, 10, Integer.parseInt(getDollar), comment.getText().toString(), String.valueOf(year)));
                            } else {
                                db.delete(Integer.parseInt(bundle.getString("id")), orig_year, orig_month, Integer.parseInt(bundle.getString("Money")), "feed");
                            ...
                            if(MyWindowManager.smallWindow != null) {
                                ...
                                MyWindowManager.removeSmallWindow(EditFeed.this);
                                MyWindowManager.createSmallWindow(EditFeed.this);
    ...
    public void setCurrentDateOnView() {
        ...
        Log.v("EditFeed", String.valueOf(orig_month));
        month = orig_month;
